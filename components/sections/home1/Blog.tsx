          ...
          <div className="row">
              ...
              <div className="blog-one__single">
                <div className="blog-one__img-box">
                  <div className="blog-one__img">
                    <img loading="lazy" src="assets/images/blog/mining-operations.webp" alt="Mining Operations" width={600} height={400} />
                  </div>
            ...
            >
              <div className="blog-one__single">
                <div className="blog-one__img-box">
                  <div className="blog-one__img">
                    <img loading="lazy" src="assets/images/blog/pharmaceutical-lab.webp" alt="Pharmaceutical Laboratory" width={600} height={400} />
                  </div>
                  <div className="blog-one__date">
                    <p>
                      15
            ...
            >
              <div className="blog-one__single">
                <div className="blog-one__img-box">
                  <div className="blog-one__img">
                    <img loading="lazy" src="assets/images/blog/oil-gas-refinery.webp" alt="Oil & Gas Refinery" width={600} height={400} />
                  </div>
                  <div className="blog-one__date">
                    <p>
                      15
