...
export default function Breadcrumb({ breadcrumbTitle }: BreadcrumbProps) {
  ...
  <section className="page-header">
    ...
    <div className="page-header__shape-2 float-bob-y">
      <img loading="lazy" src="assets/images/shapes/page-header-shape-2.webp" alt="Decorative page header shape" />
    </div>
    <div className="page-header__shape-3 float-bob-x">
      <img loading="lazy" src="assets/images/shapes/page-header-shape-3.webp" alt="Decorative page header shape" />
    </div>
